...
def get_top_movers(date: str) -> dict:
    """
    KOSPI + KOSDAQ 전 종목 조회 후 급등/급락 TOP N 반환.
    반환 구조:
      {
        "gainers": [{"ticker", "name", "change", "close"}, ...],
        "losers":  [...]
      }
    """
    frames = []
